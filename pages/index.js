...
export default function Home() {
  return (
    <div className="container">
      <Head>
        <title>Sarah et Julien</title>
        <link rel="icon" href="/favicon.ico" />
        <link rel="preconnect" href="https://fonts.gstatic.com" />
        <link
          href="https://fonts.googleapis.com/css2?family=Marck+Script&family=Montserrat&family=PT+Mono&display=swap"
          rel="stylesheet"
        />
      </Head>
...
-140 86 l-28 6 21 -53z"
          ...
          <div className="grid">
            ...
            >
              ...
              <div className="location">
                <h4 className="location_name">Flins-sur-Seine</h4>
                <address className="location__address">
                  Parc Jean boileau, 78410 Flins-sur-Seine
                </address>
              </div>
            </a>
            ...
            >
              ...
              <div className="location">
                <h4 className="location__name">La Grange du Lavoir</h4>
                <address className="location__address">
                  8 Rue du Lavoir, 27120 Houlbec-Cocherel
                </address>
              </div>
      ...
      <style jsx>{`
        ...
        .description {
          text-align: center;
          text-shadow: 0 -1px 0 #777, 0 6px 8px rgba(0, 0, 0, 0.4);
        }
        ...
        .card:focus:before,
        .card:active:before {
          background: var(--interactive-color, black);
        }

        .card:hover:after,
        .card:focus:after,
        .card:active:after {
          border-color: var(--interactive-color, black);
        }
        ...
        .card__time {
          ...
          border-radius: 4px;
          box-shadow: 0 8px 6px -6px #00000033;
        }
        ...
        .planning dl > div:nth-of-type(odd) {
          align-self: flex-end;
        }

        .planning dl > div:nth-of-type(even) {
          justify-content: flex-end;
        }

        .planning div:nth-of-type(odd) dd {
          order: -1;
        }

        .planning div:nth-of-type(even) > dt:after,
        .planning div:nth-of-type(odd) > dd:after {
          display: inline-block;
          content: "—";
          padding: 0 0.25rem;
        }
      ...
      <style jsx global>{`
        :root {
          ...
          --secondary-color: #57674b;
          --tertiary-color: #6a5d82;
          --interactive-color: #f4c2d2;
        }
